...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/20 21:04:31 by dpogrebn          #+#    #+#             */
/*   Updated: 2018/02/20 21:04:32 by dpogrebn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_converse_char(t_printf *params, void *number)
{
	...
	|| !ft_strcmp(params->convers, "C")) && MB_CUR_MAX == 4)
...
void		ft_converse(t_printf *params, void *string)
{
	...
	else if (params->convers[0] == 'i' || params->convers[0] == 'd'
		|| params->convers[0] == 'u' || params->convers[0] == 'D'
		|| params->convers[0] == 'U' || params->convers[0] == 'o'
		|| params->convers[0] == 'x' || params->convers[0] == 'O'
