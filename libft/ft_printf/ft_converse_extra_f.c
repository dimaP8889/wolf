...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_converse_extra_f.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dpogrebn <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/20 21:03:44 by dpogrebn          #+#    #+#             */
/*   Updated: 2018/02/20 21:03:47 by dpogrebn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_find_base(t_printf *params)
{
	...
	!ft_strcmp(params->convers, "X") || !ft_strcmp(params->convers, "p"))
		return (16);
	else
		return (10);
}
