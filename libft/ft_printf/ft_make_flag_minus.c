...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_make_flag_minus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dpogrebn <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/20 21:08:07 by dpogrebn          #+#    #+#             */
/*   Updated: 2018/02/20 21:08:07 by dpogrebn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (flag->sharp_x == 1 || flag->sharp_xh == 1 || flag->sharp_p == 1)
...
static void	ft_flag_minus_move_str(t_printf *params, t_flags_num *flag)
{
	...
	else if (flag->sharp_x == 1 || flag->sharp_xh == 1 || flag->sharp_p)
	{
