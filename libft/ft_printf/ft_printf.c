...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/20 21:11:14 by dpogrebn          #+#    #+#             */
/*   Updated: 2018/02/20 21:11:16 by dpogrebn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_sort_flags(t_printf *params)
{
	...
	{
		if (ft_find_base_flags(params->flag[count_flags])
			> ft_find_base_flags(params->flag[count_flags + 1]))
		{
