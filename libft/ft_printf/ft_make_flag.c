...
static void	ft_flag_zero(t_printf *params, t_flags_num *flag)
{
	char	*zero;
	int		count;
	...
	|| !params->check_num) && !ft_strchr(params->flag, '-'))
	{
...
static void	ft_flag_plus(t_printf *params, t_flags_num *flag)
{
...
static void	ft_flag_space(t_printf *params, t_flags_num *flag)
{
...
static void	ft_flag_sharp(t_printf *params, t_flags_num *flag)
{
	int		count;
